-- Migration: Fix challenge start delay - users can only complete tasks starting the day after registration
-- This migration adds logic to prevent users from completing tasks on the same day they register
