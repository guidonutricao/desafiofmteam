-- Migration: Add webhook integration for new user registration
-- This migration adds webhook functionality to send user data when a new account is created
...
AS $$
DECLARE
  webhook_url text := 'https://n8n.guidonutri.com/webhook-test/2f60b388-e1a4-4703-b6ea-e85ea8f0511b';
...
DO $$ 
BEGIN 
  RAISE NOTICE 'Webhook integration added successfully!';
  RAISE NOTICE 'New user registrations will now be sent to: https://n8n.guidonutri.com/webhook/2f60b388-e1a4-4703-b6ea-e85ea8f0511b';
END $$;